...
const operationalData = [
  ...
  { phase: "Operation", ref: "OP-09", hazard: "Operating on uneven ground (tip over)", existing: "Ground assessment before setup; stabiliser pads used on soft/uneven surfaces; maximum slope per manufacturer spec; operator to seek supervisor approval on marginal ground", extra: "Ground assessment pre-setup; use stabiliser pads", likelihood: 2, consequence: 4, risk: 8 },

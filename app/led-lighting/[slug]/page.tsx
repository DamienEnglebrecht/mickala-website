...
const products = [
  ...
  },
  {
    ...
    statLine: "320W – 1800W · Architectural + Industrial · German engineering",
    models: [
      ...
      { name: "DL2-1200", label: "1200W", image: "/dark-licht.jpg" },
      { name: "DL3-1800", label: "1800W", image: "/dark-licht.jpg" },
    ],
    specs: [
      ["Power Range", "320W – 1800W"],
      ["Service Life", "LM80 | up to 192000 hrs"],
    ...
    features: [
      ...
      "Up to 192000 hours service life (LM80)",

...
const categories: Record<string, CategoryData> = {
  "single-axle": {
    ...
    models: [
      { name: "MLT 1280-4LED", led: "1200W", desc: "Entry-level single axle. Compact and lightweight for fast-moving worksites.", image: "/product-images/doc_f9ffe13e2ce8_mlt-1280-4led-single-axle-tower.png", slug: "single-axle-1280-4led", priceFrom: "", specSheet: "/spec-sheets/single-axle-1280-4led.pdf", lightSim: "/spec-sheets/single-axle-1280-4led-lightsim.pdf" },
      { name: "MLT 1280-6LED", led: "1200W", desc: "Higher output with 6-LED array for medium-sized work areas.", image: "/product-images/doc_675019b64b3f_mlt-1280-6led-single-axle-tower.png", slug: "single-axle-1280-6led", priceFrom: "", specSheet: "/spec-sheets/single-axle-1280-6led.pdf", lightSim: "/spec-sheets/single-axle-1280-6led-lightsim.pdf" },
      { name: "MLT 1920-LED", led: "1920W", desc: "Maximum illumination for large-scale operations on a single axle.", image: "/product-images/doc_9db394285565_mlt-1920-led-single-axle-tower.png", slug: "single-axle-1920-led", priceFrom: "", specSheet: "/spec-sheets/single-axle-1920-led.pdf", lightSim: "/spec-sheets/single-axle-1920-led-lightsim.pdf" },
      { name: "MLT 2560-LED", led: "2560W", desc: "Extreme output for the largest work sites. Single axle, maximum coverage.", image: "/product-images/doc_ca1d46669f30_mlt-2560-led-single-axle-tower.png", slug: "single-axle-2560-led", priceFrom: "", specSheet: "/spec-sheets/single-axle-2560-led.pdf", lightSim: "/spec-sheets/single-axle-2560-led-lightsim.pdf" },
    ],
    specs: [
      ["Wattage", "1200W – 2560W"],

...
const categories: Record<string, CategoryData> = {
  "single-axle": {
    ...
    statLine: "4 models · 1,200W – 2,560W · Rapid deployment",
    models: [
      { name: "MLT 1280-4LED", led: "1,200W", desc: "Entry-level single axle. Compact and lightweight for fast-moving worksites.", image: "/product-images/doc_f9ffe13e2ce8_mlt-1280-4led-single-axle-tower.png", slug: "single-axle-1280-4led", specSheet: "/spec-sheets/single-axle-1280-4led.pdf", lightSim: "/spec-sheets/single-axle-1280-4led-lightsim.pdf" },
      { name: "MLT 1280-6LED", led: "1,200W", desc: "Higher output with 6-LED array for medium-sized work areas.", image: "/product-images/doc_675019b64b3f_mlt-1280-6led-single-axle-tower.png", slug: "single-axle-1280-6led", specSheet: "/spec-sheets/single-axle-1280-6led.pdf", lightSim: "/spec-sheets/single-axle-1280-6led-lightsim.pdf" },
      { name: "MLT 1920-LED", led: "1,920W", desc: "Maximum illumination for large-scale operations on a single axle.", image: "/product-images/doc_9db394285565_mlt-1920-led-single-axle-tower.png", slug: "single-axle-1920-led", specSheet: "/spec-sheets/single-axle-1920-led.pdf", lightSim: "/spec-sheets/single-axle-1920-led-lightsim.pdf" },
      { name: "MLT 2560-LED", led: "2,560W", desc: "Extreme output for the largest work sites. Single axle, maximum coverage.", image: "/product-images/doc_ca1d46669f30_mlt-2560-led-single-axle-tower.png", slug: "single-axle-2560-led", specSheet: "/spec-sheets/single-axle-2560-led.pdf", lightSim: "/spec-sheets/single-axle-2560-led-lightsim.pdf" },
    ],
    specs: [
      ["Wattage", "1,200W – 2,560W"],
      ["Mast Type", "Telescopic"],
      ["Voltage", "ELV 24VDC"],
      ["Compliance", "MDG15, MDG41"],
      ["Paint Process", "3-stage, e-coated, baked 180°C"],
      ["Warranty", "12 months / 1,500 hrs"],
    ],
    features: [
  ...
  "dual-axle": {
    ...
    statLine: "3 models · 2,560W – 3,840W · Heavy-duty stability",
    models: [
      { name: "MLT 2560-LED", led: "2,560W", desc: "Dual axle stability with high-output LED array for demanding conditions.", image: "/product-images/doc_caaa568cee08_mlt-2560-led-dual-axle-tower.png", slug: "dual-axle-2560-led", specSheet: "/spec-sheets/dual-axle-2560-led.pdf", lightSim: "/spec-sheets/dual-axle-2560-led-lightsim.pdf" },
      { name: "MLT 3200-LED", led: "3,200W", desc: "High-output lighting for large industrial sites.", image: "/product-images/doc_0db128540ed1_mlt-3200-led-dual-axle-tower.png", slug: "dual-axle-3200-led", specSheet: "/spec-sheets/dual-axle-3200-led.pdf", lightSim: "/spec-sheets/dual-axle-3200-led-lightsim.pdf" },
      { name: "MLT 3840-LED", led: "3,840W", desc: "Maximum coverage and illumination — the flagship dual axle model.", image: "/product-images/doc_830a8f6c08db_mlt-3840-led-dual-axle-tower.png", slug: "dual-axle-3840-led", specSheet: "/spec-sheets/dual-axle-3840-led.pdf", lightSim: "/spec-sheets/dual-axle-3840-led-lightsim.pdf" },
    ],
    specs: [
      ["Wattage", "2,560W – 3,840W"],
      ["Mast Type", "Telescopic"],
      ["Voltage", "ELV 24VDC"],
      ["Compliance", "MDG15, MDG41"],
      ["Paint Process", "3-stage, e-coated, baked 180°C"],
  ...
  "sled-mount": {
    ...
    statLine: "3 models · 2,560W – 3,840W · Skid-mounted",
    models: [
      { name: "MLS 2560-LED", led: "2,560W", desc: "Entry-level sled mount. Compact skid design for crane and forklift deployment.", image: "/product-images/doc_9ba284db2a30_mls-2560-led-sled-mounted-tower.png", slug: "sled-mount-2560-led", specSheet: "/spec-sheets/sled-mount-2560-led.pdf", lightSim: "/spec-sheets/sled-mount-2560-led-lightsim.pdf" },
      { name: "MLS 3200-LED", led: "3,200W", desc: "High-output sled mount for remote sites requiring maximum uptime.", image: "/product-images/doc_fdeca1e9b4f9_mls-3200-led-sled-mounted-tower.png", slug: "sled-mount-3200-led", specSheet: "/spec-sheets/sled-mount-3200-led.pdf", lightSim: "/spec-sheets/sled-mount-3200-led-lightsim.pdf" },
      { name: "MLS 3840-LED", led: "3,840W", desc: "Maximum illumination for remote operations. The ultimate sled mount tower.", image: "/product-images/doc_abd280e3fc3c_mls-3840-led-sled-mounted-tower.png", slug: "sled-mount-3840-led", specSheet: "/spec-sheets/sled-mount-3840-led.pdf", lightSim: "/spec-sheets/sled-mount-3840-led-lightsim.pdf" },
    ],
    specs: [
      ["Wattage", "2,560W – 3,840W"],
      ["Mast Type", "Telescopic"],
  ...
  "long-range": {
    ...
    statLine: "2 models · 4,800W – 7,200W · High-mast ready",
    models: [
      { name: "MLR 4800-LED", led: "4,800W", desc: "Extended runtime and coverage for large-scale operations.", image: "/product-images/doc_8391d0d6a389_mlr-4800-led-sled-mounted-tower.png", slug: "long-range-4800-led", specSheet: "/spec-sheets/long-range-4800-led.pdf", lightSim: "/spec-sheets/long-range-4800-led-lightsim.pdf" },
      { name: "MLR 7200-LED", led: "7,200W", desc: "Maximum coverage for the largest mining and industrial sites.", image: "/product-images/doc_b1045367b1fd_mlr-7200-led-sled-mounted-tower.png", slug: "long-range-7200-led", specSheet: "/spec-sheets/long-range-7200-led.pdf", lightSim: "/spec-sheets/long-range-7200-led-lightsim.pdf" },
    ],
    specs: [
      ["Wattage", "4,800W – 7,200W"],

    ...
    <div className="min-h-screen bg-gray-50 print:bg-white print:p-0">
      ...
      {/* Print / Details Buttons */}
        ...
        <table className="w-full text-xs mb-6">
          <tbody>
            <tr><td className="font-semibold py-1 pr-4 w-40">Quote Reference</td><td className="text-left">MMMQ{new Date().getFullYear()}-<input type="number" value={quoteNum} onChange={e => setQuoteNum(Number(e.target.value))} className="border-b border-dashed border-gray-300 bg-transparent w-20 px-0 py-0.5 text-sm font-semibold text-primary focus:outline-none focus:border-primary print:border-none inline" style={{width:"3rem"}} /></td></tr>
            <tr><td className="font-semibold py-1 pr-4">Date</td><td className="text-left">{date}</td></tr>
            {quoteType === "Hire Quote" && (
              <>
                <tr><td className="font-semibold py-1 pr-4">Hire Period From</td><td className="text-left"><input type="date" value={hireFrom} onChange={e => setHireFrom(e.target.value)} className="border-b border-dashed border-gray-300 bg-transparent w-full px-0 py-0.5 text-sm focus:outline-none focus:border-primary print:border-none" /></td></tr>
                <tr><td className="font-semibold py-1 pr-4">Hire Period To</td><td className="text-left"><input type="date" value={hireTo} onChange={e => setHireTo(e.target.value)} className="border-b border-dashed border-gray-300 bg-transparent w-full px-0 py-0.5 text-sm focus:outline-none focus:border-primary print:border-none" /></td></tr>
              </>
            )}
            <tr><td className="font-semibold py-1 pr-4">Prepared For</td>
              <td className="text-left"><input type="text" value={customer} onChange={e => setCustomer(e.target.value)} placeholder="Customer name" className="border-b border-dashed border-gray-300 bg-transparent w-full px-0 py-0.5 text-sm focus:outline-none focus:border-primary print:border-none text-left" /></td></tr>
            <tr><td className="font-semibold py-1 pr-4">Customer Contact</td>
              <td className="text-left"><input type="text" value={customerContact} onChange={e => setCustomerContact(e.target.value)} placeholder="Contact name" className="border-b border-dashed border-gray-300 bg-transparent w-full px-0 py-0.5 text-sm focus:outline-none focus:border-primary print:border-none text-left" /></td></tr>
            ...
            <tr><td className="font-semibold py-1 pr-4">Payment Terms</td>
              <td className="text-left">
                {useCustomTerms ? (
                  <input type="text" value={customTerms} onChange={e => { setCustomTerms(e.target.value); setPaymentTerms(e.target.value) }} placeholder="Type custom payment terms..." className="border-b border-dashed border-gray-300 bg-transparent w-full px-0 py-0.5 text-sm focus:outline-none focus:border-primary print:border-none text-left" />
                ) : (
                  ...
                  }} className="border-b border-dashed border-gray-300 bg-transparent w-full px-0 py-0.5 text-sm focus:outline-none focus:border-primary cursor-pointer print:border-none text-left">
            ...
            <tr><td className="font-semibold py-1 pr-4">Delivery</td>
              <td className="text-left">
                <select value={delivery} onChange={e => setDelivery(e.target.value)} className="border-b border-dashed border-gray-300 bg-transparent w-full px-0 py-0.5 text-sm focus:outline-none focus:border-primary cursor-pointer print:border-none text-left">
                ...
                {delivery === "Custom..." && (
                  <input type="text" value="" onChange={e => setDelivery(e.target.value)} placeholder="Type delivery terms..." className="border-b border-dashed border-gray-300 bg-transparent w-full px-0 py-0.5 text-sm focus:outline-none focus:border-primary print:border-none mt-1 text-left" autoFocus />
                )}
              </td></tr>
          </tbody>
        </table>

  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={`max-w-3xl mx-auto p-4 sm:p-8 ${printingFull ? 'hidden' : ''}`}>
        <Link href="/documents" onClick={(e) => { e.preventDefault(); if (window.history.length > 1) { router.back() } else { router.push('/documents') } }} className="inline-flex items-center text-sm text-muted-foreground hover:text-foreground mb-4"><ArrowLeft className="mr-1 h-4 w-4" /> Back</Link>

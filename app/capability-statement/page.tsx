...
const features = [
  ...
  { feature: "Extra Low Voltage (24/48VDC)", status: "Standard", benefit: "Any auto electrician or fitter can work on them — no high-voltage risk" },
  { feature: "Remote Start & Stop (Timer Mode)", status: "Standard", benefit: "Auto start/stop reduces fuel waste and engine hours" },
  ...
  { feature: "LED Low-Level Fuel Beacon", status: "Standard", benefit: "Never run out of fuel — 24hr notice when activated. Emails central network" },
  { feature: "Lockable Starter & Battery Isolators", status: "Standard", benefit: "Complies with mining safety standards; prevents unauthorised use" },
  { feature: "LED Tail Lights & Beacons", status: "Standard", benefit: "Lower maintenance, longer life than incandescent" },
  { feature: "Jump Start Receptacle", status: "Standard", benefit: "No risk of battery explosion from jumper leads" },
  { feature: "Emergency Stop x 2", status: "Standard", benefit: "Complies with highest mining safety standards" },
  { feature: "MDG15 & MDG41 Compliant", status: "Standard", benefit: "Movement across states is uncompromised — NSW ready" },
  { feature: "GPS Remote Monitoring", status: "Option", benefit: "Real-time internet surveillance of location and machine health" },
  { feature: "Remote Control Operation", status: "Option", benefit: "Less downtime when operations progress during shift" },
  { feature: "3-Stage Paint Process", status: "Standard", benefit: "E-coated & baked at 180°C. Final 2 coats 2K Polyurethane. Lifetime protection" },
  { feature: "Fire Extinguisher (4.5–9kg)", status: "Standard", benefit: "Compliant with site safety requirements" },
  { feature: "Air Pre-Cleaner", status: "Standard", benefit: "Longer life air filters in dusty environments" },
]
    ...
    <div className="bg-white">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-20 w-full">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mb-10 leading-relaxed">
              Australia's leading privately owned OEM manufacturer of Extra Low Voltage LED lighting towers — delivering innovation through continuous improvement since 2007.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>Mickala Lighting Towers' philosophy focuses on the importance of forming close alliances and long-term relationships with our clients. At the core of this philosophy is a complete understanding that as a sustainable long-term service contractor with a pre-eminent industry reputation for performance, quality and reliability in providing high quality extra low voltage LED Lighting Towers.</p>
                <p>Our strong team culture is supported by exceptional service from our factory trained technicians. In such a highly competitive industry, Mickala Lighting Towers' principles and its continued dynamic leadership, investment in its employees, dedication to be the industry's best and to be proactive and innovatively responsive to our clients' needs, positions Mickala as an industry leader.</p>
                <p>Today, Mickala Lighting Towers is Australia's leading privately owned OEM LED Lighting Tower manufacturer, combined with our attention to safety, quality, environment and continuous improvement — this sets us apart from our competitors.</p>
                <p>Mickala Lighting Towers has 100% control of our supply chain, significantly reducing costs which we can pass onto our clients while supplying tomorrow's technology today.</p>
              </div>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: Lightbulb, title: "OEM Manufacturing", desc: "Original Equipment Manufacturer of Extra Low Voltage LED Lighting Towers — designed and engineered in-house." },
              { icon: TrendingUp, title: "Direct Sales", desc: "Purchase new Mickala LED Lighting Towers direct from the manufacturer with full warranty and support." },
              { icon: Truck, title: "Direct Hire", desc: "Short or long-term hire of our fleet of LED Lighting Towers with flexible commercial terms." },
              { icon: HeadphonesIcon, title: "Turnkey Maintenance", desc: "Hire, Maintain, Service and Refuel contracts — we manage your fleet end to end." },
              { icon: Wrench, title: "Repair & Maintenance Workshop", desc: "Fully equipped workshop for repairs, servicing and refurbishment of all lighting tower makes." },
              { icon: Settings, title: "Mobile Support", desc: "Factory trained technicians available for on-site warranty, maintenance and breakdown support — 24/7." },
            ].map((item, i) => (
      ...
      <section className="py-20 sm:py-28 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mt-3 mb-6">Supporting Our Clients With Cost Reductions Year on Year</h2>
          <p className="text-gray-400 max-w-2xl mx-auto mb-12 text-lg">Delivering products and services whilst providing continuous improvement through innovation.</p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 text-left">
            {[
              ...
              "Reduce administration costs for our clients as well as carbon footprint",
              "Achieve preferred supplier status through proven capability and performance",
              "Supply safe and cost-effective project solutions and services",
              "Ensure our employees always represent us in a professional and safety-conscious manner",
              "Build business partnerships with clients and the wider community",
            ].map((item, i) => (
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: Users, title: "Experienced Personnel", desc: "In-house and external training ensures our employees are continually up-skilled in servicing, diagnostics and repairs." },
              { icon: Layers, title: "OEM Supply Chain", desc: "100% control of product quality, inventory levels and minimal dispatch timeframes across NSW and Central Queensland." },
              { icon: Wrench, title: "Standard Parts", desc: "Every model regardless of size has interchangeable components — reduces inventory complexity." },
            ].map((item, i) => (
              <div key={i} className="bg-white rounded-xl p-6 border border-gray-100 hover:shadow-lg transition-shadow">
                <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-red-50 text-red-600 mb-4">
                  <item.icon className="h-5 w-5" />
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mt-3 mb-6 leading-tight">International OEM Supply Chain</h2>
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>Mickala Lighting Towers is part of an international OEM group of companies and supply chain. This allows us to fulfil customer demands through 90% of all component procurement for each Mickala ELV LED Lighting Tower within the Mickala Group of companies.</p>
                <p>This offers our clients security that Mickala Lighting Towers are able to provide valuable service, support through labour, components and technical support for the life of the asset.</p>
                <p>Every single part that is utilised on each tower has been through comprehensive field testing on our own hire fleet.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">Mickala's international semi-autonomous modern-day facility has the capacity to produce in excess of 500 LED lighting towers per annum.</p>
      ...
      <section className="py-16 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">All raw fabricated components are hydrostatically submerged in paint to ensure long lasting protection. Each component is then baked at 180°C to ensure each part is protected for life.</p>
      ...
      <section className="py-16 bg-red-600 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-red-100 mb-8 max-w-xl mx-auto">Contact us today to discuss your lighting tower requirements. We'll provide a competitive solution tailored to your site.</p>
